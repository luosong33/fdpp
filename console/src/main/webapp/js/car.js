...
$(function () {
    ...
    $("#li2").click(function () {
        // alert(123)
        $.ajax({
            url: 'query/batch/car_findBaofeiInfo',
            type: 'post',
            // async: false,
            data: {
                params: "{}",
            ...
            dataType: 'json',
            success: function (data) {
                console.log("========================query/batch/car_findBaofeiInfo========================")
                console.log(data)
                var datatemo = data[0];
                /*main3总览柱状*/
