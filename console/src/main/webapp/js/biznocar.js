...
function flush() {
    $.ajax({
        url: 'query/biznocar/findBaofeiInfo',
        type: 'post',
        // async: false,
        data: {
            params: "{}",
...
$(function () {
    function flush(){
        $.ajax({
            url: 'query/biznocar/findJrbfInfo',
            type: 'post',
            asnyc: false,
            data: {
                params:"{}",
...
$(function () {
    ...
    $("#li2").click(function () {
        // alert(123)
        $.ajax({
            url: 'query/batch/biznocar_findBaofeiInfo',
            type: 'post',
            // async: false,
            data: {
                params: "{}",
            ...
            dataType: 'json',
            success: function (data) {
                console.log("========================query/batch/biznocar_findBaofeiInfo========================")
                console.log(data)
                var datatemo = data[0];
                /*main3总览柱状*/
...
$(document).ready(function () {
    ...
    function dataxzbf() {
        $.ajax({
            url: 'query/biznocar/findXzbfInfo',
            type: 'post',
            // async: false,
            data: {
                params: "{}",
