...
<head>
    ...
    <script src='js/syfcx.js'></script>
    <script src='js/gonggong.js'></script>
    <script src='js/fangun.js'></script>
</head>
...
<div id='center'>
    ...
    <div class='center'>
        <div class='cbqx Floor'>
            <div class='cb_header'>
                <em class='cb_em1' style='background:url(img/nav_title3.png)'></em><em class='cb_em'></em>
                <div class='biaotou'>
                    <i>今日保费(元)</i>
                    <span class='tp'></span><span class='numberRun'></span>
                </div>
                <div class='biaotou'>
                    <i>今日签单(单)</i>
                    <span class='tp1'></span><span class='numberRun1'></span>
                </div>
                <div class='biaotou'>
                    <i>更新数据时间</i>
                    <span id='time' style='font-size:15px;'>2016-10-08 10:18</span>
                </div>
