		...
		<div id='center'>
			 <div id='header'>
			 	<div class='tou'>
					<center> <span id='header_log'></span>
					 <ul class='her_ul'>
						<li ><a href="PICC.jsp" style='background:url(img/nav_bg.png);color:white;'>总览</a></li>
						<li><a href="chexian.jsp">车险</a></li>
						<li><a href="syfcx.jsp">商业非车险</a></li>
			 ...
			 <div class='center'>
			 	   <div class='cbqx Floor'  >
			 	   	     <div class='cb_header'>
			 	   	     	<em class='cb_em1'></em><em class='cb_em'></em>
			 	   	     	<div class='biaotou'>
			 	   	     		<i>今日保费(元)</i>
			 	   	     		<span class='tp'></span><span id='numberRun' class='numberRun'>0</span>
			 	   	     	</div>
			 	   	     	<div class='biaotou'>
			 	   	     		<i>今日签单(单)</i>
			 	   	     		<span class='tp1'></span><span id ='numberRun1' class='numberRun1'>0</span>
			 	   	     	</div>
			 	   	        <div class='biaotou'>
			 	   	     		<i>更新数据时间</i>
			 	           ...
			 	           <div class='right'></div>
			 	   	     ...
			 	   	     <div class='tubiao'>
			 	   	     <span  onclick="siMenu('li1')" style='position:absolute;background:#00aade;color:#fff;'><i id='li1'>保单</i></span>
			 	   	     <span  onclick="siMenu('li2')" style='position:absolute;border:1px solid #f1f3f4;left:70px;background:#fff;'><i id='li2'>批单</i></span>
			 	   	     </div>
			 	   	     <div id='top_main'>
			 	   	    ...
			 	   	    <div id='top_main1' style='display:none'>
			 	   	      <div id='main' style="width: 900px;height:300px;float:left;margin-left:47px;">    第二个页面</div> 	     
			 	          
			 	   	       <div id="xuxing" style="width: 900px;height:200px;float:left;margin-left:47px;">    第二个页面</div>
			 	   	   </div>
			    	...
			    	<%--<div class='zgs Floor'>
			 	   	  <div class='zgs_div'>
			 	   	  	 <span class='zgs_span_left' >总公司</span>
			 	   	  	  ...
			 	   	  	  <span class='zgs_span_right' style='background:url(img/mnav_right_bg.png)' id='ryn1' onclick="tab('ryn1')">日</span> 
			 	   	  </div>
			 	   	  	 <div class='tab_class'>
			 	   	     ...
			 	   	     <span  onclick="siMenu('li4')" style='position:absolute;border:1px solid #f1f3f4;left:70px;background:#fff;'><i id='li4'>报表</i></span>
			 	   	     </div>
			 	   	          <div id='zgs_bottom'>
			 	   	     ...
			 	   	     <span  onclick="siMenu('li6')" style='position:absolute;border:1px solid #f1f3f4;left:70px;background:#fff;'><i id='li6'>报表</i></span>
			 	   	     </div>
			 	   	     ...
			 	   	     <span  onclick="siMenu1('li8')" style='position:absolute;left:70px;border:1px solid #f1f3f4;background:#fff;'><i id='li8'>报表</i></span>
			 	   	     </div>
